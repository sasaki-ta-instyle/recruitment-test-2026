    ...
    <main className="wide-shell">
      ...
      <section className="guide-section" id="section-policy">
        ...
        <p className="muted" style={{ marginTop: 0 }}>
          重要度の高い順に並べている：<b>素直 ＞ 自他 ＝ 貢献 ＞ ポジネガ</b>。
        </p>
        <ul>
          <li><b>素直軸（素直 ↔ 素直じゃない）：</b>フィードバックや変化を受け止めて動くか、前提を検証してから動くか。<b>最重要軸</b>。</li>
          <li><b>自他軸（自責 ↔ 他責）：</b>問題が起きたとき「自分の動き」を先に見るか、「外の動き」を先に見るか。</li>
          <li><b>貢献軸（貢献あり ↔ 貢献なし）：</b>「自分の成果」より「チームの成果」を先に置けるか。</li>
          <li><b>ポジネガ軸（ポジ ↔ ネガ）：</b>可能性ベースで考えるか、リスクベースで考えるか。職種・役割で活きる場面が異なる。</li>
        </ul>
        ...
        <ol>
          ...
          <li>Part 2 を各問 0〜10 の整数（1 点刻み）で採点し、100 点満点で集計。10 / 7 / 4 / 0 はアンカー、中間値も使ってよい。</li>
      ...
      <section className="guide-section" id="section-flow">
        ...
        <ol>
          ...
          <li>
            <b>Step 6 — Part 2 採点：</b>各問 0〜10 の整数（1 点刻み）で採点し、100 点満点で集計。10/7/4/0 はアンカー、中間値も使ってよい。0 点が 3 問以上ある場合は別途検討。
          </li>
          <li>
